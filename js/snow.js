...
var snowStorm = (function(window, document) {
    ...
    this.scrollHandler = function() {
        ...
        scrollY = storm.flakeBottom
            ? 0
            : parseInt(
                  window.scrollY || document.documentElement.scrollTop || (noFixed ? document.body.scrollTop : 0),
                  10
              );
        if (isNaN(scrollY)) {
            ...
            if (!storm.useMeltEffect || !s.melting) {
                ...
                if (s.meltFrame < s.meltFrameCount) {
                    ...
                    s.o.style.lineHeight =
                        storm.flakeHeight + 2 + storm.flakeHeight * 0.75 * (s.meltFrame / s.meltFrameCount) + "px";
                    s.meltFrame++;
                } else {
                    s.recycle();
                }
